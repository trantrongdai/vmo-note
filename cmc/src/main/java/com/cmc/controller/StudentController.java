...
public class StudentController extends RestBaseController {
    ...
    public RestResponse<StudentResponseDto> createStudent(@Valid @RequestBody StudentRequestDto requestDto) {
        ...
        return new RestResponse.RestResponseBuilder(StatusCode.SUCCESS.getValue(),
                new StudentResponseDto(createdStudent))
                .build();
    }
